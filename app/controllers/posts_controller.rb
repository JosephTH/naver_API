class PostsController < ApplicationController
  ...
  def map_data
    ...
    min = JSON.parse(params[:min]) #JSON_string => hash {y: 37.5657666, _lat: 37.5657666, x: 126.9755874, _lng: 126.9755874}
    ...
    school_id -= indices #기존 네이버 맵에 로딩되어 있지 않은 학교들의 id들만 저장되어 있음
